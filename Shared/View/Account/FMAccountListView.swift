        ...
        .popup(isPresented: $shouldShowEditAccount, overlayView: {
            BottomPopupView(title: "Edit Account", shouldDismiss: $shouldShowEditAccount) {
                if let selectedAccountRowViewModel = viewModel.selectedAccountRowViewModel {
                    FMAddAccountView(name: selectedAccountRowViewModel.account.name ?? "", comments: selectedAccountRowViewModel.account.accountDescription ?? "", shouldPresentAddAccountView: $shouldShowEditAccount, accountRowViewModel: selectedAccountRowViewModel)
